...
export const Notes: Note[] = [
    ...
    {id: 2,  title: 'Jog', completed: false},
    {id: 3,  title: 'Play', completed: false},
    {id: 4,  title: 'Yoga', completed: false},
    {id: 5,  title: 'Sleep', completed: false},
    {id: 6,  title: 'Market', completed: false},
    {id: 7,  title: 'Meat', completed: false},
    {id: 8,  title: 'That', completed: false},
    {id: 9,  title: 'Dart', completed: false},
    {id: 10,  title: 'Mellow', completed: false},
    {id: 11,  title: 'Hank', completed: false},
    {id: 12,  title: 'Part', completed: false}
